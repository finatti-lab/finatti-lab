...
export default function Contact() {
  return (
    <section id="contato" className="relative overflow-hidden">
      {/* Split Layout */}
      <div className="grid lg:grid-cols-2 gap-0 min-h-[800px]">
        ...
        <div className="bg-white p-8 md:p-12 lg:p-16 flex flex-col justify-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-3">Entre em Contato</h2>
          <p className="text-stone-600 mb-8">Estamos prontos para atender você com excelência e humanidade</p>
        ...
        <div className="bg-terracota text-white p-8 md:p-12 lg:p-16 flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl font-bold mb-8">Informações de Contato</h3>
